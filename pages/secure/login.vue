              ...
              <b-card-body>
                <b-form @submit.prevent="signInWithPassword()">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <b-form-input id="input1" type="email" v-model="email" required placeholder="Enter email"></b-form-input>
                  </div>
                  <div class="input-group mb-4">
                    <span class="input-group-addon"><i class="icon-lock"></i></span>
                    <b-form-input id="input2" type="password" v-model="password" required placeholder="Enter password"></b-form-input>
                  </div>
                  <b-row>
                    <b-col cols="6">
            ...
            <b-card no-body class="text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <b-card-body class="text-center">
                <div>
                  ...
                  <p>
                    <strong>Welcome!</strong> Log in to access admin portal
                  </p>
                </div>
              </b-card-body>
            </b-card>
